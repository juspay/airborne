...
const config: Config = {
  ...
  // Served by the Airborne server under /docs/ (see airborne_server/src/docs.rs).
    ...
    [
      "classic",
      {
        docs: {
          ...
          // The whole site is already served under /docs/ (baseUrl), so docs live at the root.
          routeBasePath: "/",
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          to: "/guides/integrate-react-native",
          label: "Guides",
          position: "left",
        },
        {
      ...
      links: [
        {
          title: "Guides",
          items: [
            { label: "Integrate in React Native", to: "/guides/integrate-react-native" },
            { label: "Integrate in Expo", to: "/guides/integrate-react-native-expo" },
            { label: "Create & target a release", to: "/guides/create-and-target-a-release" },
          ],
        },
        {
          title: "Reference",
          items: [
            { label: "React Native SDK", to: "/react-native-sdk/integration/getting-started" },
            { label: "React Native CLI", to: "/react-native-cli/getting-started" },
            { label: "Core CLI", to: "/core-cli/getting-started" },
