...
const sections: Card[] = [
  {
    ...
    to: "/react-native-sdk/integration/getting-started",
  },
  {
      ...
      <div className="container">
        <div className={styles.heroInner}>
          ...
          <div className={styles.heroButtons}>
            <Link className="button button--primary button--lg" to="/guides/integrate-react-native">
              Get started
            </Link>
