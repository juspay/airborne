...
This API is identical across the [plain React Native](/react-native-sdk/integration/getting-started) and [Expo](/react-native-sdk/expo/getting-started) tracks.
...
- [Android API](/react-native-sdk/reference/android-api) and [iOS API](/react-native-sdk/reference/ios-api) — the native callbacks behind these functions.
- [Callbacks & events](/react-native-sdk/reference/callbacks-and-events) — the SDK event stream.
