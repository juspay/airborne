...
Install the `airborne-react-native` package and register the Airborne Maven repository so Android can resolve the native SDK. After this, continue with the native [Android](/docs/react-native-sdk/integration/android-setup) and [iOS](/docs/react-native-sdk/integration/ios-setup) setup.
...
Continue with **[Android setup](/docs/react-native-sdk/integration/android-setup)**.
