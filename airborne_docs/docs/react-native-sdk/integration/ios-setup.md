...
:::note[Prerequisites]
Make sure you have completed [Install the SDK](/react-native-sdk/integration/install), including running `pod install`, before proceeding.
:::
...
Continue with **[Bundling the release config](/react-native-sdk/integration/bundling-release-config)**.
