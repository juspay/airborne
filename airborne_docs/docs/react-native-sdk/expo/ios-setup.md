...
See the [iOS API reference](/react-native-sdk/reference/ios-api) for the full `AirborneDelegate` protocol and the [callbacks & events reference](/react-native-sdk/reference/callbacks-and-events) for the events delivered to `onEvent`.
...
- If you have not done so yet, complete [Android setup](/react-native-sdk/expo/android-setup).
