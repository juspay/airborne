...
Once your files are registered, bundle them into a [package](/dashboard/packages) (an index file plus its supporting files), then ship that package in a [release](/dashboard/releases).
