...
| Page | What it covers |
| --- | --- |
| [Authentication & onboarding](/dashboard/authentication-and-onboarding) | Signing in, registering, OIDC, and creating your first organisation. |
| [Organisations](/dashboard/organisations) | Creating and switching organisations and the org overview. |
| [Applications](/dashboard/applications) | Creating an application and reading the app overview. |
| [Users & roles](/dashboard/users-and-roles) | Inviting users and the RBAC permission model. |
| [Files](/dashboard/files) | Registering files, version history, and tags. |
| [Packages](/dashboard/packages) | Bundling an index file plus other files into a package. |
| [Releases](/dashboard/releases) | The 6-step release wizard, rollout lifecycle, and analytics. |
| [Dimensions](/dashboard/dimensions) | Targeting dimensions and their priority order. |
| [Cohorts](/dashboard/cohorts) | Segmenting users with checkpoints and groups. |
| [Remote configs](/dashboard/remote-configs) | The JSON schema builder for remote configuration. |
| [Views](/dashboard/views) | Saved dimension filters for slicing releases. |
| [Access tokens](/dashboard/access-tokens) | Personal access tokens for the CLIs. |

:::tip
If you just want to ship something end to end, follow the [Create & target a release guide](/guides/create-and-target-a-release). It walks through files → package → release in one sitting.
:::
