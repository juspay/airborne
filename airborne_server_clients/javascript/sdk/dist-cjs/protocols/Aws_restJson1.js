...
const se_DeleteFileCommand = async (input, context) => {
    ...
    const query = (0, smithy_client_1.map)({
        [_fi]: [, (0, smithy_client_1.expectNonNull)(input[_fi], `file_id`)],
