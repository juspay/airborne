 ...
 * @public
 */
export class CreateOrganisationCommand extends $Command.classBuilder<CreateOrganisationCommandInput, CreateOrganisationCommandOutput, AirborneClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
