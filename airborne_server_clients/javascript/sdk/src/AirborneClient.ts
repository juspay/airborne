...
import {
  ...
  defaultAirborneHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type AirborneClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>>
  & ClientDefaults
  & UserAgentInputConfig
  & CustomEndpointsInputConfig
  & RetryInputConfig
 ...
 * @public
 */
export type AirborneClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions>
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<AirborneClientConfig>) {
    ...
    this.middlewareStack.use(getHttpAuthSchemePlugin(this.config
      , {
        httpAuthSchemeParametersProvider: defaultAirborneHttpAuthSchemeParametersProvider,identityProviderConfigProvider: async (config: AirborneClientResolvedConfig) => new DefaultIdentityProviderConfig({
