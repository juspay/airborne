...
import { GetPackageGroupRequest, PackageGroup } from "../models/models_0";
...
declare const GetPackageGroupCommand_base: {
    new (input: GetPackageGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetPackageGroupCommandInput, GetPackageGroupCommandOutput, AirborneClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetPackageGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetPackageGroupCommandInput, GetPackageGroupCommandOutput, AirborneClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetPackageGroupCommand extends GetPackageGroupCommand_base {
