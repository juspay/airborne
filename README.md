...
| Variable | Required | Encrypted | Default | Description |
|----------|----------|-----------|---------|-------------|
| `ENABLE_GOOGLE_SIGNIN` | No | No | `false` | Enable Google Sign-In for organization creation |
| `ORGANISATION_CREATION_DISABLED` | No | No | `false` | Disable organization creation via API |
