          ...
          <main className="flex-1 p-6">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="flex gap-2">
                ...
                <Button asChild>
                  <Link href={`/dashboard/${encodeURIComponent(org)}/${encodeURIComponent(appId)}/releases/create`}>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-lg font-bold">
                            {new Date(application.lastDeployment).toLocaleDateString()}
                          </p>
                        </div>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Button asChild>
                        <Link href={`/applications/${encodeURIComponent(appId)}/releases/create`}>
                          <Rocket className="h-4 w-4 mr-2" />
                          Create Release
                        </Link>
                      </Button>
