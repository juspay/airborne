...
export default function ApplicationDetailPage() {
  ...
  const { data } = useSWR(
    token && org && app ? ["/releases/list"] : null,
    async () => apiFetch<any>("/releases/list", {}, { token, org, app })
  );
                  ...
                  <TableBody>
                    {releases.slice(0, 5).map((r) => (
                      <TableRow
                        ...
                        onClick={() =>
                          router.push(
                            `/dashboard/${org}/${app}/releases/${encodeURIComponent(
                              r.id
                            )}`
                          )
                        }
                      >
                        <TableCell className="font-mono text-sm">
                          <Link
                            href={`/dashboard/${org}/${app}/releases/${encodeURIComponent(
                              r.id
                            )}`}
