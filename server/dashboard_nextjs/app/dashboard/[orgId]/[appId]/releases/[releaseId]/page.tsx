...
type ServeReleaseConfig =
    Pick<ReleasePayload, "config" | "resources"> & {
        package: Pick<
            ReleasePayload["package"],
            "version" | "properties" | "index" | "important" | "lazy"
        >;
}
          ...
          <main className="flex-1 p-6">
            ...
            <div className="flex items-center gap-4 mb-8">
              <Button variant="ghost" size="sm" asChild>
                <Link href={`/dashboard/${orgId}/${appId}/releases`}>
              ...
              <div className="flex gap-2">
                ...
                <Button 
                  onClick={concludeRelease}
                  disabled={isConcluding || release.experiment.status === "CONCLUDED"}
                >
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium">
                          {errorCount === 0 ? "100%" : `${((totalDownloads - errorCount) / totalDownloads * 100).toFixed(1)}%`}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
