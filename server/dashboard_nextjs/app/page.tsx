      ...
      <header className="border-b border-border bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-card/50 sticky top-0 z-50">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="https://github.com/juspay/airborne" target="_blank" className="text-sm hover:text-primary transition-colors">
              Source
            </Link>
          </nav>
      ...
      <section className="bg-primary text-primary-foreground py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button
              onClick={
                () => window.location.href = "mailto:pp-sdk@juspay.in"
              }
              size="lg"
              variant="outline"
      ...
      <footer className="border-t border-border bg-muted/30">
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="h-8 w-8 rounded-lg flex items-center justify-center">
                  <Image src="/airborne-cube-logo.png" alt="Airborne Logo" width={16} height={16} className="h-8 w-8"></Image>
                </div>
                <span className="font-bold text-lg font-[family-name:var(--font-space-grotesk)]">Airborne</span>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <Link href="https://github.com/juspay/airborne" target="_blank" className="block text-muted-foreground hover:text-foreground">
                  Github
                </Link>
          ...
          <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row items-center justify-between">
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Airborne. All rights reserved.</p>
