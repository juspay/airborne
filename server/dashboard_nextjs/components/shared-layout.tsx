...
export default function SharedLayout({ children }: SharedLayoutProps) {
  ...
  const navigationItems: NavItem[] = appIdPath
    ? [
        {
          href: "/dashboard/" + org + "/" + app,
          icon: Activity,
          label: "Overview",
        },
        {
          href: "/dashboard/" + org + "/" + app + "/files",
          icon: FileText,
          label: "Files",
        },
        {
          href: "/dashboard/" + org + "/" + app + "/packages",
          icon: Package,
          label: "Packages",
        },
        {
          href: "/dashboard/" + org + "/" + app + "/releases",
          icon: Rocket,
          label: "Releases",
        },
        {
          href: "/dashboard/" + org + "/" + app + "/views",
          icon: Eye,
          label: "Views",
        },
        {
          href: "/dashboard/" + org + "/" + app + "/dimensions",
          icon: Sliders,
          label: "Dimensions",
        },
      ]
  ...
  return (
    <div className="min-h-screen bg-background h-full">
        ...
        <div className="flex h-16 items-center px-6">
          <div className="flex items-center gap-4">
            <Link href="/dashboard" className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg font-[family-name:var(--font-space-grotesk)]">
                Airborne
              </span>
            </Link>
      ...
      {isOrgCreateModelOpen && (
        <Dialog
          open={isOrgCreateModelOpen}
          onOpenChange={setIsOrgCreateModelOpen}
        >
          <DialogContent className="sm:max-w-md">
            ...
            <DialogFooter>
              <Button
                variant="outline"
                onClick={() => setIsOrgCreateModelOpen(false)}
              >
                Cancel
              </Button>
