...
import { Dimension } from "./DimensionPriority";
import { useToast } from "../../utils";

interface CreateDimensionProps {
  onSuccess ?: (data:Dimension ) => void;
}

export default function CreateDimension({onSuccess}: CreateDimensionProps) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      onSuccess(data);
      showSuccess("Dimension created successfully!");
      ...
      showError("Failed to create dimension");
    } finally {
          ...
          <div className="flex items-center justify-between mb-6 pb-6 border-b border-white/20 p-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-white/70">Add a new dimension to {app}</p>
              </div>
