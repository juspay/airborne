...
pub async fn generate_random_key() -> Result<String> {
    run_blocking!({
...
pub async fn encrypt_string(plaintext: &str, key_b64: &str) -> Result<String> {
...
pub async fn decrypt_string(encrypted_b64: &str, key_b64: &str) -> Result<String> {
