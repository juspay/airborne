...
) -> Result<Json<CohortDimensionSchema>> {
...
async fn create_cohort_checkpoint_api(
    ...
    auth_response: ReqData<AuthResponse>,
    state: web::Data<AppState>,
) -> Result<Json<types::CreateCohortDimensionCheckpointOutput>> {
    let cohort_dimension_id = cohort_dimension.into_inner();
    let auth_response = auth_response.into_inner();
...
async fn create_cohort_group_api(
    ...
    auth_response: ReqData<AuthResponse>,
    state: web::Data<AppState>,
) -> Result<Json<types::CreateCohortGroupOutput>> {
    let cohort_dimension_id = cohort_dimension.into_inner();
...
async fn get_cohort_priority_api(
    ...
    auth_response: ReqData<AuthResponse>,
    state: web::Data<AppState>,
) -> Result<Json<types::GetPriorityOutput>> {
...
async fn update_cohort_priority_api(
    ...
    auth_response: ReqData<AuthResponse>,
    state: web::Data<AppState>,
) -> Result<Json<types::UpdatePriorityOutput>> {
    let cohort_dimension_id = cohort_dimension.into_inner();
