    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Invite a new user to <strong>{organizationName}</strong> with read-only organization access. Select which
            applications they should have access to. You can change access levels later.
          </DialogDescription>
        </DialogHeader>
