...
import { validateValueAgainstSchema } from "@/components/remote-config/utils/helpers";
import { convertDottedToNestedObject } from "@/components/remote-config/utils/helpers";
                ...
                <pre className="hljs text-xs p-3 rounded border overflow-auto max-h-48">
                  <code
                    ...
                    dangerouslySetInnerHTML={{
                      __html: hljs.highlight(JSON.stringify(convertDottedToNestedObject(remoteConfigValues), null, 2), {
                        language: "json",
                      }).value,
                    }}
                  />
