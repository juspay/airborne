        ...
        <TabsContent value="preview">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review your JSON schema. You can copy the JSON schema or export your configurations. You can also see
                the current and previous states of your configurations.
              </CardDescription>
            </CardHeader>
            <CardContent>
